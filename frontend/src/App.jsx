...
if (closeOnSuccess) {
  ...
  const Header = () => {
    ...
    return (
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#09140f]/88 backdrop-blur-xl border-b border-white/10 overflow-x-hidden">
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-2 sm:py-2.5">
          {/* TOP */}
            ...
            <div className="flex items-center gap-3 min-w-0">
              <div className="flex items-center flex-shrink-0">
                <img
                  ...
                  className="w-24 sm:w-32 h-auto drop-shadow-[0_10px_28px_rgba(8,15,30,0.45)]"
                  loading="lazy"
                />
              </div>
              ...
              <nav className="hidden md:flex items-center justify-center gap-2 pl-2">
                <button
                  ...
                  className={`px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest transition-all border ${
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {!me ? (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-3 py-2 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest bg-emerald-500/15 hover:bg-emerald-500/25 transition-all border border-emerald-300/35 text-white"
                >
                ...
                <>
                  ...
                  <button
                    onClick={logout}
                    className="px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest bg-white/5 hover:bg-white/10 transition-all border border-white/15 text-white"
                  >
                    Salir
                  </button>
                </>
          ...
          {/* TABS (mobile) */}
          <nav className="mt-2 md:hidden flex items-center justify-center sm:justify-start gap-2 w-full">
            <button
              onClick={() => setView("public")}
              className={`px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest transition-all border ${
                view === "public" ? "bg-emerald-600/85 border-emerald-300/55 text-white" : "bg-white/5 border-white/10 hover:bg-white/10"
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden relative">
      ...
      <main className="min-h-screen pt-24 sm:pt-28 relative z-10">
        {/* PUBLIC */}
        {view === "public" && (
          <PublicHomeView
