            ...
            {activeTab === "info" && (
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <label className="text-sm md:col-span-2">
                    <div className="text-white/60 mb-1">Flyer</div>

                    {/* URL persistida (compat) */}
                    <input
                      className="w-full rounded-xl bg-white/5 border border-white/10 px-3 py-2"
                      value={editFormData.flyer_url || ""}
                      onChange={(e) => setEditFormData({ ...editFormData, flyer_url: e.target.value })}
                      placeholder="/uploads/... ó /static/uploads/..."
                    />
                    ...
                    <div className="mt-2 flex flex-col gap-2">
                      <input
                        ...
                        accept="image/*"
                        className="w-full rounded-xl bg-white/5 border border-white/10 px-3 py-2"
                        onChange={(e) => onPickFlyerFile(e?.target?.files?.[0] || null)}
                      />
                      <div className="text-xs text-white/50">
                        Tip: al subir una nueva imagen, se actualiza automáticamente el flyer del evento.
                      </div>
