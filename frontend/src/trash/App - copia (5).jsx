  ...
  useEffect(() => {
    ...
    const tick = async () => {
      ...
      try {
        ...
        if (found) {
          // Limpia el hash de checkout para no re-entrar en mpWait si recarga
          try {
          ...
          setView("myTickets");
          // refresca por si el usuario entra con filtros
          setTimeout(() => { try { loadMyAssets(); } catch {} }, 50);
          return;
        }
      } catch (e) {
        // ignore transient
          ...
          <div className="pt-0 pb-20 px-6 max-w-7xl mx-auto animate-in fade-in text-white">
            <div className="max-w-2xl mx-auto">
              <div className={`p-10 rounded-[2.5rem] ${UI.card} text-center`}>
                <div className="text-[11px] tracking-widest uppercase text-white/50 mb-3">
                  CONFIRMACION DE PAGO
                </div>
                <h2 className="text-3xl md:text-4xl font-black mb-3">Estamos generando tus entradas, LAS RECIBIRAS 48 HS ANTES DEL EVENTO</h2>
                ...
                <div className="mt-7 flex items-center justify-center gap-3">
                  ...
                  <div className="text-[12px] text-white/70">
                    Procesando… {mpReturn?.order_id ? `Orden ${String(mpReturn.order_id).slice(0, 8)}…` : ""}
                  </div>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                  <button
                    onClick={() => {
                      try { setView("myTickets"); setTimeout(() => { try { loadMyAssets(); } catch {} }, 50); } catch {}
                    }}
                    className="px-6 py-3 rounded-2xl bg-white/10 hover:bg-white/15 border border-white/10 text-[12px] font-semibold"
                  >
                    Ir a Mis Tickets
                  </button>
                  <button
                    ...
                    className="px-6 py-3 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-[12px]"
                  >
                ...
                <div className="mt-6 text-[11px] text-white/40">
                  Si te quedás acá más de 1 minuto, tocá “Ir a Mis Tickets” y actualizá.
                </div>
              </div>
            </div>
          </div>
