                  ...
                  <div className="flex items-center justify-between gap-4 pt-2">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-2xl font-black text-indigo-400 italic mt-1">
                        {(() => { const sub = (selectedTicket?.price || 0) * quantity; const fee = sub * 0.15; return formatMoney(sub + fee); })()}
                      </div>
                      <div className="mt-2 text-[11px] text-neutral-400 space-y-1">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-black">{formatMoney(((selectedTicket?.price || 0) * quantity) * 0.15)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
