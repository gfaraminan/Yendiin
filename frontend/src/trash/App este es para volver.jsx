          ...
          <div className="flex flex-col md:flex-row gap-10 md:items-start md:justify-between">
            <div className="min-w-0">
              ...
              <div className="text-[11px] text-white/50 mt-2 max-w-md">
                Plataforma de tickets con QR antifraude. Cartelera pública + panel Productor en un solo lugar.
              </div>
              <button
                onClick={() => {
                  if (!me) {
                ...
                className="mt-5 inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-white text-[10px] font-black uppercase tracking-widest transition-all"
              >
                Productor
              </button>
