...
if (!selectedTicket || !name || !address || !dni) {
  alert("Por favor completa Nombre, DNI y Domicilio.");
  return;
}
if (dni.length !== 7) {
  alert("El DNI debe tener 7 números.");
  return;
}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const v = String(e.target.value || "").replace(/\D/g, "").slice(0, 7);
                        setCheckoutForm({ ...checkoutForm, dni: v });
                      }}
                      placeholder="DNI (7 números)"
                      inputMode="numeric"
                      maxLength={7}
                      autoComplete="off"
                      className="w-full px-4 py-3 rounded-2xl bg-white/5 border border-white/10 text-[12px] font-bold"
