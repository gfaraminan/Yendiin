          ...
          {featured.map((ev) => {
            ...
            return (
              <button
                ...
                className={`min-w-[280px] md:min-w-[360px] snap-start text-left overflow-hidden rounded-[2.5rem] ${UI.card} hover:border-indigo-600/40 transition-all`}
              >
        ...
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-white font-black uppercase italic tracking-tight text-xl md:text-2xl leading-none">
