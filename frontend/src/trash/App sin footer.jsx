  ...
  const Header = () => {
    return (
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/50 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-4 sm:py-5 flex flex-wrap items-center justify-between gap-x-4 gap-y-3 overflow-x-clip">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-indigo-600 flex items-center justify-center shadow-[0_0_40px_rgba(79,70,229,0.45)] flex-shrink-0">
            ...
            <div>
              ...
              <div className="text-white font-black uppercase italic tracking-tight text-xl sm:text-2xl leading-none">
                Ticket<span className="text-indigo-500">Pro</span>
              </div>
            </div>
          </div>

          <nav className="flex items-center gap-2 order-3 w-full sm:w-auto sm:order-none justify-center sm:justify-start flex-shrink-0">
            <button
