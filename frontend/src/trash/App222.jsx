...
export default function App() {
  ...
  const saveEvent = async () => {
    ...
    try {
      ...
      // refrescamos ambas listas para que el evento nuevo aparezca en Producer
      await refreshProducerEvents();
      await refreshPublicEvents();

      // Si el backend devuelve el slug final (por ej. al crear), lo usamos
      if (data?.event?.slug) {
        setSelectedEventSlug(data.event.slug);
      }
