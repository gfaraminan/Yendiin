...
const slugify = (input = "") => {
  ...
  const noAccents = (typeof s.normalize === "function")
...
const EditorModal = ({
  ...
  // Alias para el Wizard (Paso 3): el UI usa eventItemDraft, pero el backend/tab usa saleDraft.
  ...
  const stepTitles = [
    "EVENTO",
    "UBICACIÓN Y FLYER",
    "SALES ITEMS Y VENDEDORES",
    "CONFIRMACIÓN",
  ];
  const stepSubtitle = [
    "Nombre, slug, fecha/hora, cobro y términos",
    "Flyer con preview + ubicación (mapa o ubicación actual)",
    "Carga inicial de sales items y vendedores",
    "Revisá y confirmá",
  ];
  ...
  const getStepErrors = (step) => {
    ...
    if (step === 0) {
      ...
      if (!editFormData?.accepted_terms) e.push("Tenés que aceptar Términos y Condiciones.");
    }
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditFormData((s) => ({ ...s, title: e.target.value }))
                    }
                ...
                <div className="md:col-span-2">
                  <label className="flex items-start gap-3 p-4 rounded-2xl border border-white/10 bg-white/5">
                    <input
                      type="checkbox"
                      checked={!!editFormData.accepted_terms}
                      onChange={(e) =>
                        setEditFormData((s) => ({
                          ...s,
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
        ...
        <div className="text-[11px] text-white/45 mt-2">
          Demo: la imagen se previsualiza localmente. Luego lo conectamos a upload real.
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <label className="text-sm">
          ...
          <input
            ...
            onChange={(e) =>
              setEditFormData({ ...editFormData, lat: e.target.value })
            }
            placeholder="-32.889..."
          />
        </label>
        ...
        <label className="text-sm">
          ...
          <input
            ...
            onChange={(e) =>
              setEditFormData({ ...editFormData, lng: e.target.value })
            }
            placeholder="-68.845..."
          />
        </label>
        ...
        <div className="md:col-span-2 flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
          ...
          <div className="text-[11px] text-white/45">
            Marcá el punto en Maps y pegá Lat/Lng, o usá tu ubicación actual.
          </div>
        </div>

        <div className="md:col-span-2 rounded-2xl overflow-hidden border border-white/10 bg-black/20">
              ...
              <div className="space-y-4">
                <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
                  ...
                  <div className="mt-4 grid md:grid-cols-2 gap-3 text-[12px] text-white/70">
                    ...
                    <div><span className="text-white/40">Términos:</span> {editFormData.accepted_terms ? "Aceptados" : "No aceptados"}</div>
                    <div><span className="text-white/40">Flyer:</span> {(flyerPreview || editFormData.flyer_url) ? "Cargado" : "Sin flyer"}</div>
