        ...
        <div className="flex flex-col lg:flex-row gap-3 lg:items-center">
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">
              Ciudad
              <select value={filterCity} onChange={(e) => setFilterCity(e.target.value)} className="mt-2 w-full rounded-2xl bg-white/5 border border-white/10 px-4 py-3 text-white text-[12px] font-black">
            ...
            <label className="text-[10px] font-black uppercase tracking-widest text-neutral-500">
              Tipo
              <select value={filterType} onChange={(e) => setFilterType(e.target.value)} className="mt-2 w-full rounded-2xl bg-white/5 border border-white/10 px-4 py-3 text-white text-[12px] font-black">
          ...
          >
            <div className="relative h-80 rounded-[1.25rem] overflow-hidden bg-black">
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 min-w-0 space-y-2">
                ...
                <div className="text-xl font-black text-indigo-300 italic">{priceLabelForEvent(ev, formatMoney)}</div>
              </div>
            </div>
          </button>
        ))}
          ...
          >
            <div className="relative h-[23rem] bg-black">
              ...
              <div className="absolute bottom-0 left-0 p-6 space-y-2 w-full">
                ...
                <div className="text-2xl font-black text-indigo-400 italic">{priceLabelForEvent(ev, formatMoney)}</div>
              </div>
            </div>
          </button>
        ))}
